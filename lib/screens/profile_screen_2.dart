  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ChangeNotifierProvider(
        ...
        child: Consumer<ProfileController2>(
            builder: (context, profileController2, child) {
          return SafeArea(
            child: Padding(
                      ...
                      children: [
                        ...
                        Stack(
                          ...
                          children: [
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: profileController2.image == null
                                        ? (userData.data()
                                        ...
                                        : Image.file(
                                            File(profileController2.image!.path)
                                                .absolute,
                                          ),
                                  ),
                                ),
                            ...
                            InkWell(
                              onTap: () {
                                profileController2.pickImage(context);
                              },
