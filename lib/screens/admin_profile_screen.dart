...
import 'package:demoapp/screens/admin_profile_controller_screen.dart';
...
class _AdminProfileScreenState extends State<AdminProfileScreen> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
        ...
        .get()
        .then((value) {
      loggedInUser = UserModel2.fromMap(value.data());
      setState(() {});
    });
  }
    ...
    return Scaffold(
      body: ChangeNotifierProvider(
        ...
        child: Consumer<AdminProfileController>(
            builder: (context, adminProfileController, child) {
          return SafeArea(
            child: Padding(
                      ...
                      children: [
                        ...
                        Stack(
                          ...
                          children: [
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: adminProfileController.image ==
                                              null
                            ...
                            InkWell(
                              onTap: () {
                                adminProfileController.pickImage(context);
                              },
