...
class ProfileController with ChangeNotifier {
  ...
  void uploadImage(BuildContext context) async {
    ...
    if (uid == null) {
      setLoading(false);
      // User not authenticated - could add SnackBar here if needed
      return;
    }
    ...
    try {
      ...
      notifyListeners();
      setLoading(false);
      // Profile Updated - could add SnackBar here if needed
    } catch (error) {
      // Handle errors
      setLoading(false);
      // Error uploading image: $error - could add SnackBar here if needed
    }
  }
}
